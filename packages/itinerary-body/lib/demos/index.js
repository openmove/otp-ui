...
const StyledItineraryBody = (0, _styledComponents.default)(_.default).withConfig({
  ...
  componentId: "ss5q7m-0"
})(["", "{background-color:pink;}", "{color:#999;font-size:14px;padding-right:4px;padding-top:1px;text-align:right;vertical-align:top;width:60px;}"], ItineraryBodyClasses.LegBody, ItineraryBodyClasses.TimeColumn);
